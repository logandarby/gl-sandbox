...
Image::Image(const std::string& filePath, const int reqComp, const bool setFlip)
{
	...
	m_imageData.imageData = ImageData::deletedUniquePtr(pixelData, [](unsigned char* pixelData) {
