...
void CameraController::onEvent(Event &e) {
    ...
    dispatcher.dispatch<KeyPressEvent>([&](KeyPressEvent &e) { m_onKeyPress(e); });
    dispatcher.dispatch<KeyReleaseEvent>([&](KeyReleaseEvent &e) { m_onKeyRelease(e); });
    dispatcher.dispatch<MouseOffsetEvent>([&](MouseOffsetEvent &e) { m_onMouseOffset(e); });
}

void CameraController::onUpdate() { m_camera.move(m_deltaPos); }

void CameraController::m_onKeyPress(KeyPressEvent &e) { m_move(e.getKeyCode(), m_spec.moveSpeed); }
