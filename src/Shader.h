...
public:
	...
	Shader& setMVP(const std::string& name, const glm::mat4& model, const glm::mat4& view, const glm::mat4& projection);
...
private:
	...
	static unsigned int compileShader(const unsigned int shaderType, const std::string& source);
